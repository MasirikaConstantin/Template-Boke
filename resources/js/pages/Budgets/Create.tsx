...
export default function BudgetCreate({ auth, flash }: BudgetCreateProps) {
  const { data, setData, errors, processing, post } = useForm({
    annee: new Date().getFullYear().toString(),
    mois: new Date().toLocaleString('fr-FR', { month: 'long' }).toLowerCase(),
    montant_alloue: 0,
    description: '',
    est_actif: true,
  });
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Remplissez les détails de ce budget mensuel
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={onSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="montant_alloue">Montant alloué (USD) *</Label>
                    <Input
                      id="montant_alloue"
                      type="number"
                      min="0"
                ...
                <div className="flex justify-end gap-2 pt-4 border-t">
                  ...
                  <Button type="submit" disabled={processing}>
                    ...
                    {processing ? 'Création...' : 'Créer le budget'}
                  </Button>
                </div>
              </form>
            </CardContent>
