...
export default function DepenseCreate({ 
  auth, 
  budgets, 
  categories, 
  budget_courant,
  ...
  const [selectedBudget, setSelectedBudget] = useState<Budget | null>(budget_courant);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  Remplissez les détails de cette dépense
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <SelectContent>
                          {budgets.map((budget) => (
                            <SelectItem key={budget.id} value={budget.id.toString()}>
                              {budget.annee} - {budget.mois} - Restant: {formatMontant(budget.montant_restant)}
                            </SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <div className="border-2 border-dashed rounded-lg p-4">
                        ...
                        {data.fichier_joint && !filePreview && (
