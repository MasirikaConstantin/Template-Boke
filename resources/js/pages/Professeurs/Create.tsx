...
interface ProfesseurCreateProps {
  classes: Classe[];
  matieres: Matiere[];
  statuts: Statut[];
...
export default function ProfesseurCreate({
  ...
  return (
    <>
      <Head title="Ajouter un nouveau professeur" />
      
      <DashboardLayout activeRoute="/professeurs">
        <PageHeader
          title="Ajouter un nouveau professeur"
          description="Remplissez le formulaire pour créer un nouveau professeur"
          breadcrumb={[
            { label: 'Dashboard', href: '/dashboard' },
            { label: 'Professeurs', href: '/professeurs' },
            { label: 'Créer', href: '/professeurs/create' },
          ]}
          actions={
